...
class Species:
    ...
    social_alignment: float = 0.0   # match nearby same-species heading (herd travels)
...
SPECIES = {
    "gazelle": Species(
        ...
        social_radius=14, social_comfort=12, social_cohesion=0.9, social_separation=0.2, social_alignment=0.8,
    ),
    "lion": Species(
        ...
        social_radius=16, social_comfort=2, social_cohesion=0.5, social_separation=0.8, social_alignment=0.35,
    ),
    "jackal": Species(
        ...
        social_radius=14, social_comfort=3, social_cohesion=0.4, social_separation=0.5, social_alignment=0.3,
    ),
}
